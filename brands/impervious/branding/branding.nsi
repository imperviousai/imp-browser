...
!define BrandFullNameInternal "Impervious"
!define BrandFullName         "Impervious"
!define CompanyName           "Impervious Technologies Inc"
!define URLInfoAbout          "https://www.impervious.ai"
!define HelpLink              "https://www.impervious.ai/support/"

!define URLStubDownloadX86 "https://example.com/${AB_CD}"
!define URLStubDownloadAMD64 "https://example.com/${AB_CD}"
!define URLStubDownloadAArch64 "https://example.com/win64-aarch64-installer/${AB_CD}"
!define URLManualDownload "https://example.com/download/landing/${AB_CD}"
!define URLSystemRequirements "https://example.com/products/"
!define Channel "release"

# The installer's certificate name and issuer expected by the stub installer
!define CertNameDownload   "Impervious Technologies, Inc."
